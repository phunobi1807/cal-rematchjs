...
export default function Home() {
  ...
  const equals = (e) => {
    ...
    if (cal === "=") {
      dispatch({ type: "myCal/setState", payload: {preState: cal,  curState: preState } });
    }
    ...
    // const payload = { ...payload, input: "", preState: cal, curState: "" };

    dispatch({ type: "myCal/setState", payload: {preState: curState, total: preState} });
  };
