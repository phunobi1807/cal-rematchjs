...
export default function Home() {
  ...
  const equals = (e) => {
    const e = e?.target.innerText;

    if (e === "=") {
      dispatch({ type: "myCal/setState", payload: {preState:cal, curState: "" } });
    }

    // dispatch({ type: "myCal/setState", payload: {preState: curState, curState: cal} });
